...
namespace Game.GeneticAlgorithm
{
    public class World
    {
        ...
        private (Individual, Individual) Mutate(Individual individualA, Individual individualB) => WorldHelper.Mutate(individualA, individualB);
        ...
        private Individual DoCrossover(Individual individualA, Individual individualB) => WorldHelper.DoCrossover(individualA, individualB);
