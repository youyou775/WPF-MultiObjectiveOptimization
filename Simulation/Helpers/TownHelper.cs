...
namespace Game.Helpers
{
    ...
    {
        private const int Linethickness = 4/2;
        private const int PathOffsetFromTown = 180 / 2;
        ...
        {
            new Vector2f(3060 / 2, 1300 / 2),
            new Vector2f(1050 / 2, 450 / 2),
            new Vector2f(450 / 2, 750 / 2),
            new Vector2f(690 / 2, 1890 / 2),
            new Vector2f(1410 / 2, 1830 / 2),
            new Vector2f(2070 / 2, 1560 / 2),
            new Vector2f(1725 / 2, 1080 / 2),
            new Vector2f(3360 / 2, 810  / 2),
            new Vector2f(3450 / 2, 1770/2 ),
            new Vector2f(2460 / 2, 240 / 2),
        };
    }
}
