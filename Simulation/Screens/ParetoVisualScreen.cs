...
namespace Game.Screens
{
    public class ParetoVisualScreen : Screen
    {
        ...
        private static Vector2f zeroOffset = new Vector2f(1508/2, 1304 / 2);
        private static Vector2f graphSize = new Vector2f(670 / 2, 670 / 2);
            ...
            List<Individual> population) : base(window, configuration)
        {
            ...
            {
                individualVisuals.Add(new CircleShape(10/2));
            }

            // Create a simple rectangle to hold our fitness graph.
            // This could just be a sprite, but this works.
            this.fitnessGraph = new RectangleShape(new Vector2f(960 / 2, 960 / 2))
            {
                Texture = new Texture("Graph.png"),
                Position = new Vector2f(1400 / 2, 500 / 2)
            };

            // Light backdrop with black border for our graph visualisation.
            // Slightly offset to look a bit nicer.
            this.fitnessGraphBackdrop = new RectangleShape(new Vector2f(1060 / 2, 960 / 2))
            {
                Position = new Vector2f(1350 / 2, 500 / 2),
