...
namespace Game.Screens
{
    public class SimulationScreen : Screen
    {
        ...
        private static Vector2f totalDistanceStringPosition = new Vector2f(Configuration.Width / 2, 50/2);

        private static Vector2f generationStringPosition = new Vector2f(50 / 2, 50 / 2);

        private static Vector2f quitStringPosition = new Vector2f(450/2 , Configuration.Height - (100/2));
            ...
            : base(window, configuration)
        {
            ...
            totalDistanceString = new FontText(new Font("font.ttf"), string.Empty, Color.Black, 3/2);
            GenerationString = new FontText(new Font("font.ttf"), $"Generation: {0}", Color.Black, 3 / 2);
            quitString = new FontText(new Font("font.ttf"), "Press 'Q' to quit.", Color.Black, 3 / 2);
        }
